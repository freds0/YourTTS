...
def synthesize_waveform(model, config, vocoder_model, sentence, use_griffin_lim=True, use_cuda=True, do_trim_silence=False)-> np.array:
    '''
...
def generate_wavfile(model, config, vocoder_model, sentences, output_folder, sr=22050, audio_format='wav') -> None:
    '''
    ...
    for index, sentence in enumerate(tqdm(sentences)):
        waveform = synthesize_waveform(model, config, vocoder_model, sentence)
        '''
...
def main():
    ...
    parser.add_argument('--checkpoint', default='/home/fred/tacotron2-singlespeaker_C2-October-07-2022_01+07AM-0cbaa0f6/checkpoint_1470000.pth', help='Checkpoint pth filepath')
    parser.add_argument('--config', default='/home/fred/tacotron2-singlespeaker_C2-October-07-2022_01+07AM-0cbaa0f6/config.json', help='Config json filepath')
    ...
    generate_wavfile(model, config, vocoder_model, sentences, args.output_folder, sr=22050, audio_format='wav')
